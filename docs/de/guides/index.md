...
```mermaid
graph LR
    A[Ihr Level] --> B{Experience?}
    B -->|New to Mental Training| C[Mentale Reise]
    B -->|Some Experience| D[Werkstatt]
    B -->|Ready for Intensive| E[Trainingslager]
    B -->|Regular Training| F[Trainingssitzung]

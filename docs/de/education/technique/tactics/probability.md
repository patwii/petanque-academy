...
```mermaid
graph TD
    A[Entscheidungspunkt] --> B[Option 1]
    A --> C[Option 2]
    A --> D[Option 3]

    B --> E[Erfolgswahrscheinlichkeit]
    B --> F[Belohnung bei Erfolg]
    B --> G[Kosten im Falle eines Scheiterns]

    C --> H[Erfolgswahrscheinlichkeit]
    C --> I[Belohnung bei Erfolg]
    C --> J[Kosten im Falle eines Scheiterns]

    D --> K[Erfolgswahrscheinlichkeit]
    D --> L[Belohnung bei Erfolg]
    D --> M[Kosten im Falle eines Scheiterns]
    ...
    N --> Q[Wählen Sie das beste Elektrofahrzeug]
    O --> Q
    P --> Q

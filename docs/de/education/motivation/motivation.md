...
```mermaid
graph TD
    A[Autonomie <br/> Wahlmöglichkeiten und Kontrolle] --> D[Intrinsisch <br/> Motivation]
    B[Kompetenz <br/> Meisterschaft &amp; Wachstum] --> D
    C[Verwandtschaft <br/> Verbindung und Zugehörigkeit] --> D
    D --> E[Nachhaltig <br/> Leistung]

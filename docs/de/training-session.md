...
::: Tipp: Die Philosophie der Trainingseinheit
...
- Stammspieler bei regionalen Turnieren
- Online-Pétanque-Gemeinschaften
- Fragen Sie Ihren Trainer nach Empfehlungen
...
|------|----------|----------|
| **Start** | Einchecken &amp; Einrichten | 15 Min. |
| **Wettbewerb** | 2-gegen-2-Spiele | 90 Minuten |
| **Reflexion** | Nachbesprechung &amp; Erkenntnisse | 15 Min. |
...
|------|----------|----------|
| **Start** | Einchecken &amp; Einrichten | 15 Min. |
| **Wettbewerbsrunde 1** | 2-gegen-2-Spiele | 60 Minuten |
| **Pause** | Ruhepause &amp; informelles Gespräch | 15 Min. |
| **Wettbewerbsrunde 2** | Partnerwechsel | 60 Min. |
| **Reflexion** | Vertiefende Nachbesprechung | 30 Min. |

### 4-Stunden-Sitzung

| Zeit | Aktivität | Dauer |
|------|----------|----------|
| **Startup** | Einchecken &amp; Einrichten | 20 Min. |
| **Wettbewerbsrunde 1** | 2-gegen-2-Spiele | 75 Minuten |
| **Pause** | Ruhepause &amp; kleiner Imbiss | 15 Min. |
| **Wettbewerbsrunde 2** | Partnerwechsel | 75 Min. |
| **Pause** | Ruhepause | 10 Min. |
...
**Wähle das Gelände:**
- Jede Woche auf einer anderen Oberfläche arbeiten
- Unterschiedliche Schwierigkeitsgrade und Bedingungen
- Manchmal wählt man bewusst unbequemes Terrain.

**Den Raum einrichten:**
- Grenzen deutlich markieren
- Messwerkzeuge vorbereiten
- Wasserstation
...
2. **Mentale Verfassung**: „Ich fühle mich konzentriert“ oder „Ich bin durch Arbeitsstress abgelenkt“
3. **Vorsatz**: „Heute möchte ich daran arbeiten, nach Fehlern ruhig zu bleiben.“
...
- Normalisiert, dass man an manchen Tagen &quot;nicht gut&quot; ist.
...
::: Regeln der Tipp-Sitzung
1. **Voller Einsatz** – Spiele, um zu gewinnen, ohne Kompromisse!
2. **Wachstum fördern** – Sich gegenseitig beim Lernen helfen
3. **Benutzerhandbücher beachten** – Respektieren Sie die individuellen Behandlungswünsche jedes Nutzers.
4. **Bleib im Moment** – Keine Handys während des Spiels
5. **Reflektiere ehrlich** – Teile mit, was wirklich in dir vorgeht.
6. **Vertraulichkeit** – Was hier geteilt wird, bleibt hier.
:::

**Die Balance:**
„Wir treten gegeneinander an wie in einem Turnier, aber wir unterstützen uns wie Teamkollegen. Hart im Spiel, sanft im Umgang miteinander.“
...
::: warning Kritisch: Machen Sie es real
**Dies ist kein lockeres Training.** Behandeln Sie es wie ein Turnier:

✅ **Tun Sie Folgendes:**
- Offizielles Ergebnis festhalten
- Genau messen
- Fußfehler pfeifen
- Nimm es ernst
- Gute Aufnahmen feiern
- Enttäuschung über Fehlschläge zeigen

❌ **Nicht tun:**
- Gewähren Sie „Wiederholungsmöglichkeiten“
- Sei zu lässig
- Schlechte Entscheidungen ignorieren
- Ein Witz zieht sich durch das ganze Spiel
- Ausreden erfinden
:::

### Der mentale Leistungskniff

**Ergebnisliste zweier Tracks:**

1. **Traditionelle Punktewertung** - Errungene Punkte
...
| Kriterium | 1 (Mangelhaft) | 3 (Gut) | 5 (Ausgezeichnet) |
|-----------|----------|----------|---------------|
| **Im Hier und Jetzt geblieben** | Über vergangene Aufnahmen nachgedacht | Meist präsent | Vollkommen im Moment |
| **Innerer Kritiker im Griff** | Harte Selbstgespräche | Erkannt und umgedeutet | Innerer Coach eingesetzt |
| **Emotionale Selbstregulation** | Sichtbare Frustration | Blieb größtenteils ruhig | Durchgehend ruhig |
| **Unterstützter Partner** | Ignoriert oder beschuldigt | Grundlegende Unterstützung | Benutzerhandbuch verwendet |
| **Fokus** | Abgelenkt, unkonzentriert | Meistens konzentriert | Laserfokussiert |
...
- Fokus: Umgang mit externem Druck

...
Der Unterschied zwischen einem guten und einem großartigen Wurf zeigt sich oft schon, bevor die Kugel die Hand verlässt. Eine gut durchdachte Vorbereitungsroutine ist Ihr Anker im Wettkampfgetümmel – eine verlässliche Abfolge, die Körper und Geist optimal auf den Wurf vorbereitet.
...
- **Konstanz**: Gleiche Vorbereitung führt zu konstanterer Ausführung
- **Fokus**: Gibt Ihrem Geist eine konstruktive Aufgabe, anstatt ihn zu grübeln.
- **Übergang**: Hilft Ihnen beim Wechsel vom Denken zum Handeln.
- **Stressmanagement**: Vertraute Handlungen beruhigen das Nervensystem.
- **Zurücksetzen**: Löscht die vorherige Aufnahme aus Ihrem Gedächtnis

## Anatomie einer effektiven Routine

Eine gute Vorbereitungsroutine vor dem Wurf besteht aus drei Phasen:

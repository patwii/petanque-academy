...
Ein Trainingstagebuch ist Ihre persönliche Aufzeichnung von Übungen, Fortschritten und Erkenntnissen. Es hilft Ihnen, Erfolge zu verfolgen, Muster zu erkennen und Ihre Fortschritte zu beschleunigen. Kopieren Sie die folgenden Abschnitte in Ihr bevorzugtes Format (Word, Google Docs, Excel, Google Sheets oder ein Notizbuch).
...
### Kopieren Sie diesen Abschnitt für jede Trainingseinheit
...
| Runde | Gegner | Punktestand | Ergebnis | Schlüsselmomente |
|-------|----------|-------|--------|-------------|
| **1** | | | S / L | |
| **2** | | | S / L | |
| **3** | | | S / L | |
...
### Fortschritte im mentalen Spiel
...
### Schießübungsprotokoll

| Datum | Zieltyp | Entfernung | Versuche | Volltreffer | Carreau | Verschiebung | Anmerkungen |
|------|-------------|----------|----------|-------------|---------|--------------|-------|
| | | | | | | | |
| | | | | | | | |
| | | | | | | | |
...
## Schneller täglicher Eintrag (vereinfacht)
...
5. Wofür bin ich in dieser Sitzung dankbar?
...
Es ist schwierig, alte Einträge zu finden.
...
4. **Niemals Rezensionen lesen** – Die Stärke liegt im Lesen vergangener Einträge.
...
| Zielbereich | Zielwert | Istwert | Fortschritt |
|-----------|--------|--------|----------|
| | | | |
| | | | |
| | | | |

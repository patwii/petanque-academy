...
::: tip Die Wahrheit über den Druck
...
```mermaid
flowchart TD
    A[Hochriskanter Moment] --> B[Kampf-oder-Flucht-Reaktion]
    B --> C[Herzfrequenz ↑]
    B --> D[Flache Atmung]
    B --> E[Muskelspannung]
    B --> F[Eingeschränkter Fokus]
    ...
    G -->|Threat Mode| H[Leistung ↓]
    G -->|Challenge Mode| I[Leistung ↑]

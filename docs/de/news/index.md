...
```mermaid
graph TD
    A[Gründung der Pétanque-Akademie] --> B[Bildungsplattform]
    A --> C[Workshop-Programm]
    A --> D[Gemeinschaftsbildung]

    B --> E[Mentale Spielinhalte]
    B --> F[Ernährungsleitfäden]
    B --> G[Trainingsmethoden]

    C --> H[Elite-Spielerforen]
    C --> I[Peer Learning]

    D --> J[Gemeinsames Wachstum]

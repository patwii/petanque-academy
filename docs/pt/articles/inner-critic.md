...
```mermaid
flowchart TD
    A[Situação de pressão] --> B[O crítico interno se ativa.]
    B --> C[&quot;Você vai sentir falta&quot;]
    B --> D[&quot;Todos estão assistindo&quot;]
    B --> E[&quot;Você sempre se engasga&quot;]
    ...
    F --> G[Desempenho ↓]
    G --> H[Mais munição para os críticos.]
    H --> B

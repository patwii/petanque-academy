...
Um diário de treino é o seu registro pessoal de prática, progresso e percepções. Ele ajuda você a acompanhar o que funciona, identificar padrões e acelerar a melhoria. Copie as seções abaixo para o formato de sua preferência (Word, Google Docs, Excel, Google Sheets ou um caderno).
...
## Modelo de Registro de Treinamento Diário
...
| Habilidade praticada | Repetições/Tempo | Taxa de sucesso | Observações |
|----------------|-----------|--------------|-------|
| **Apontando** | | | |
| **Filmagem** | | | |
| **Leitura do Terreno** | | | |
...
| Rodada | Adversário | Placar | Resultado | Momentos-chave |
|-------|----------|-------|--------|-------------|
| **1** | | | V / D | |
| **2** | | | V / D | |
| **3** | | | V / D | |
...
| Data | Tipo de Alvo | Distância | Tentativas | Acertos Diretos | Carreau | Deslocamento | Observações |
|------|-------------|----------|----------|-------------|---------|--------------|-------|
| | | | | | | | |
| | | | | | | | |
| | | | | | | | |
...
## Registro Diário Rápido (Simplificado)
...
2. Quando me senti mais confiante?
3. Quando tive dificuldades? Por quê?
...
4. O que vou praticar de forma diferente com base no que aprendi hoje?
5. Do que me orgulho, independentemente do resultado?

### Reflexão Semanal

1. Que padrão estou observando na minha prática?
2. Estou praticando aquilo com que tenho dificuldade em competições?
...
## Diário digital vs. diário de papel

### Digital (Google Docs/Sheets, Notion, Aplicativos)

**Prós:**
- Fácil de pesquisar entradas anteriores
- Pode adicionar fotos/vídeos
...
- Dificuldade em pesquisar entradas antigas
...
::: Aviso: Erros Comuns em Diários
1. **Detalhado demais** - Passar 30 minutos escrevendo e desistir depois de uma semana.
2. **Muito vago** - &quot;Treinei hoje, foi razoável&quot; não ajuda a melhorar.
3. **Registre apenas as falhas** - Comemore também as vitórias!
4. **Nunca revise** - O poder está em ler as postagens anteriores.
...
| Área de Objetivo | Meta | Real | Progresso |
|-----------|--------|--------|----------|
| | | | |
| | | | |
| | | | |

...
```mermaid
graph LR
    A[Modo técnico] -->|Step into circle| B[Modo de fluxo]
    B -->|After throw| C[Observação]
    C -->|Próximo arremesso| A
...
- **[Treinamento Técnico vs. Treinamento de Fluidez](/pt/education/the-zone/technical-vs-flow)** - Entendendo quando focar na técnica e quando relaxar
- **[Entrando na Zona](/pt/education/the-zone/entering-the-zone)** - Técnicas práticas para acessar o estado de fluxo

...
```mermaid
graph TD
    A[Autonomia <br/> Escolha e Controle] --> D[Intrínseco <br/> Motivação]
    B[Competência <br/> Domínio e Crescimento] --> D
    C[Afinidade <br/> Conexão e Pertencimento] --> D
    D --> E[Sustentável <br/> Desempenho]

...
```mermaid
graph LR
    A[Jornada do Workshop] --> B[Encontro presencial]
    B --> C[Construir confiança]
    C --> D[Sessões online]
    D --> E[Suporte contínuo]
    E --> F[Crescimento contínuo]
...
```mermaid
graph TD
    A[Formato do workshop] --> B[Fase 1: Presencial]
    A --> C[Fase 2: Online]

    B --> D[Construir confiança]
    B --> E[Estabelecer dinâmicas]
    B --> F[Defina metas]

    C --> G[Check-ins regulares]
    C --> H[Compartilhamento contínuo]
    C --> I[Horários flexíveis]

...
Definir metas parece simples: decida o que você quer e trabalhe para alcançar isso. Mas a definição de metas em alto nível é mais complexa. As metas certas aceleram o desenvolvimento; as erradas criam frustração e estagnação.

## Além dos objetivos básicos

A maioria dos jogadores estabelece metas de resultado: &quot;Ganhar o campeonato regional&quot;. Essas metas apresentam problemas:
- Você não pode controlar totalmente os resultados.
- Eles criam pressão sem direção.
- Sucesso ou fracasso é binário
- Eles não orientam a prática diária.
...
Esses fatores são totalmente controláveis e contribuem para o alcance de metas de desempenho.

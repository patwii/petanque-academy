...
```mermaid
graph TD
    A[Maestría en petanca] --> B[Fundación Técnica]
    A --> C[Juego mental]
...
**Primero, explora la [Paleta de Lanzamientos](/es/education/technique/throws)** para comprender las posibilidades. Luego, decide qué lanzamiento específico quieres añadir a tu repertorio. Solo entonces deberías empezar a trabajar en cómo deben moverse tu brazo, muñeca y cuerpo para lograr ese resultado.
...
```mermaid
graph LR
    A[Conocimientos técnicos] --> B[Decisiones informadas]
    B --> C[Desarrollo Enfocado]
    C --> D[Dominio de habilidades clave]
    D --> E[Acceso al estado de flujo]

...
```mermaid
graph TD
    A[Estado de flujo] --> B[Equilibrio entre desafío y habilidad]
    A --> C[Metas claras]
    A --> D[Retroalimentación inmediata]
    A --> E[Enfoque total]
    A --> F[Pérdida de la autoconciencia]
    A --> G[Sentido de control]
...
```mermaid
graph LR
    A[Evaluación <br/> Círculo exterior] --> B[Transición <br/> Entrar al círculo]
    B --> C[Configuración física <br/> En círculo]
    C --> D[Visualización <br/> 2-3 segundos]
    D --> E[Ejecución <br/> Tirar]
...
|------------|---------------------|------------------|
| **Interno** ❌ | La mecánica de tu cuerpo | &quot;Mantén mi codo recto&quot;<br/> &quot;Seguir adelante adecuadamente&quot;<br/> &quot;No agarres demasiado fuerte&quot; |
| **Externo** ✅ | Objetivo y resultado | &quot;Aterrízalo justo ahí&quot;<br/> &quot;Ver el camino&quot;<br/> &quot;Dar en el blanco&quot; |
...
```mermaid
graph LR
    A[Respiración lenta] --> B[Activa el sistema de calma]
    B --> C[Frecuencia cardíaca más baja]
    B --> D[Músculos relajados]
    B --> E[Mente clara]
...
```mermaid
graph LR
    A[Error] --> B[DETENER <br/> Pausa]
    B --> C[OBSERVAR <br/> Aviso]
    C --> D[ACEPTAR <br/> Sucedió]
    D --> E[DESLIZAR <br/> Déjalo ir]
    E --> F[Regreso al presente]

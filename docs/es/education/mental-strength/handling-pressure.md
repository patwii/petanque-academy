...
```mermaid
graph TD
    A[Situación de presión] --> B{Your Response}
    B -->|Anxiety| C[Caídas de rendimiento]
    B -->|Excitement| D[El rendimiento aumenta]

    C --> E[Pensamientos negativos]
    C --> F[Tensión]
    C --> G[Mala concentración]

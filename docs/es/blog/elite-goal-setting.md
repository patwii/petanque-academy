...
Establecer metas parece simple: decide qué quieres y trabaja para lograrlo. Pero establecer metas a nivel de élite es más matizado. Las metas correctas aceleran el desarrollo; las incorrectas generan frustración y estancamiento.

## Más allá de los objetivos básicos

La mayoría de los jugadores se fijan objetivos de resultado: «Ganar el campeonato regional». Estos objetivos presentan problemas:
- No puedes controlar completamente los resultados
- Crean presión sin dirección
- El éxito o el fracaso son binarios
- No guían la práctica diaria
...
Son totalmente controlables y están orientados a alcanzar objetivos de rendimiento.

...
Esta guía completa te ayuda a organizar y dirigir un campamento de entrenamiento de fin de semana que combina teoría, práctica y competición. Combina el contenido de juego mental de este sitio con la aplicación práctica en la pista para lograr el máximo impacto.
...
## Planificación previa al campamento
...
-Dividirse en equipos de 3-4 para practicar y competir.
...
|------|------------------|----------|
| **Coordinador de Desempeño Mental** | Facilitar sesiones teóricas, dinámicas de grupo | 1 |
| **Entrenador técnico** | Supervisar la práctica, brindar retroalimentación | 1-2 |
| **Director de competición** | Organizar el torneo, gestionar la logística | 1 |
| **Personal de apoyo** | Comidas, instalación, administración | 1-2 |

### Requisitos de ubicación

::: Necesidades de instalaciones de información
**Pista:**
...
2. **[Fuerza mental](./educacion/fuerza-mental/)** (25 min)
...
3. **[Atención plena](./educación/atención plena/)** (25 min)
...
4. **[Tácticas](./educación/tácticas/)** (20 min)
...
2. Confianza en el estado: &quot;Soy un 7 sobre 10&quot;
3. Nombra el pensamiento interno: &quot;Mi voz interior me preocupa el efecto retroceso&quot;.
4. Ejecutar el tiro
...
- &quot;Nombra 5 capitales&quot; o &quot;Contad hacia atrás desde 100 de 7 en 7&quot;
...
- &quot;Marc necesita silencio después de un fallo&quot; - el equipo lo honra
- Debrief: &quot;¿Cómo te sentiste al ser comprendido?&quot;
...
|---------|--------------|----------|
| **Terreno 1: Blando/Arena** | Aceptación de la incertidumbre | &quot;La donnée - aceptar lo que es&quot; |
| **Terreno 2: Duro/Grava** | Precisión bajo presión | &quot;Confía en tu técnica&quot; |
| **Terreno 3: Desigual** | Regulación emocional | &quot;Mantén la calma cuando es injusto&quot; |
...
1. Identifica la frase crítica exacta
2. Reformular como Coach Interno
...
2. **Protocolos de equipo (20 min)**
   ...
   - &quot;Necesito un reinicio&quot; = toca la petanca
...
**El escéptico:**
- &quot;Esto de ser sensiblero no funciona&quot;
...
- ✅ Úsalo como momento de aprendizaje
...
**Check-in individual:**
- Envía un mensaje de texto a cualquier persona que haya compartido mucho.
- ¿Cómo te sientes respecto al fin de semana?
- Abordar cualquier vulnerabilidad residual

### Corto plazo (2 semanas)

**Sesión online opcional (60-90 min):**
-¿Cómo has aplicado los aprendizajes?
...
-¿Qué hay de diferente en tu juego?
...
**Ajustes:**
- Grupo único para toda la teoría
...
|------|------------------|-----------|-----------|
| **Inscripción** | 150-250 € | 3.000-5.000 € | 1.500-2.500 € |
...
| **Premios** | 100-200 € | Artículos de reconocimiento |
...
- [ ] Cambio de comportamiento (uso de herramientas en competición)
- [ ] Mejora del rendimiento (autoinformado)
...
- Apresurándose a la siguiente actividad
...
- Mezcla de roles
- **Solución:** Límites claros entre MPC y entrenador técnico
...
- [Guía de la sesión de entrenamiento](./training-session) - Para la práctica continua
- [Nutrición](./educacion/nutricion/) - Protocolos para el día de competición
- [Fuerza Mental](./educacion/fuerza-mental/) - Conceptos del juego interior
- [Mindfulness](./educacion/mindfulness/) - Técnicas de presencia
- [Tácticas](./educación/tácticas/) - Pensamiento estratégico

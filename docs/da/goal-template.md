...
Denne skabelon hjælper dig med at sætte meningsfulde mål og systematisk spore dine fremskridt. Kopier afsnittene nedenfor til dit foretrukne format (Word, Google Docs, Excel, Google Sheets eller en notesbog).
...
|------------|---------------------|--------------|----------------|
| **Pegepræcision** | | | Eksempel: 70 % inden for 10 cm ved 7 m |
...
| Område | Nuværende tilstand | Måltilstand | Praksismetode |
|------|---------------|--------------|-----------------|
| **Trykstyring** | | | Eksempel: Brug 3-åndedrætsnulstilling før hvert skud |
| **Indre kritiker** | | | |
| **Fokus/Koncentration** | | | |
| **Selvtillid** | | | |
...
| Område | Nuværende | Mål | Handlingsplan |
|------|---------|--------|-------------|
| **Fitnessniveau** | | | |
| **Fleksibilitet** | | | |
| **Udholdenhed** | | | |
...
| Målområde | Oprindeligt mål | Justering nødvendig | Nyt mål |
|-----------|---------------|-------------------|------------|
| | | | |
| | | | |
| | | | |
...
| Dato | Turnering | Runde nået | Placering | Nøglestyrker | Områder der skal forbedres | Mental tilstand (1-10) |
|------|------------|---------------|-----------|---------------|------------------|---------------------|
| | | | | | | |
| | | | | | | |
| | | | | | | |
...
4. **Ingen gennemgang** - Går glip af muligheder for at justere

...
En træningsdagbog er din personlige registrering af øvelser, fremskridt og indsigter. Den hjælper dig med at spore, hvad der virker, identificere mønstre og accelerere forbedringer. Kopier afsnittene nedenfor til dit foretrukne format (Word, Google Docs, Excel, Google Sheets eller en notesbog).
...
| Øvede færdigheder | Gentagelser/tid | Succesrate | Noter |
|----------------|-----------|--------------|-------|
| **Peger** | | | |
| **Skydning** | | | |
| **Terrænmåling** | | | |
...
| Runde | Modstander | Score | Resultat | Nøgleøjeblikke |
|-------|----------|-------|--------|-------------|
| **1** | | | H / L | |
| **2** | | | H / L | |
| **3** | | | H / L | |
...
| Færdighed | Månedens start | Månedens slut | Forbedring |
|-------|----------------|--------------|-------------|
| **Pegepræcision** | | | |
| **Konsistens i optagelser** | | | |
| **Terræntilpasning** | | | |
| **Udvalg af billeder** | | | |

### Mentalt spilfremskridt

| Område | Månedens start | Månedens slut | Forbedring |
|------|----------------|--------------|-------------|
| **Trykstyring** | | | |
| **Fokuskvalitet** | | | |
| **Selvtillid** | | | |
...
### Logbog for skydetræning

| Dato | Måltype | Afstand | Forsøg | Direkte træf | Målgruppe | Forskydning | Noter |
|------|-------------|----------|----------|-------------|---------|--------------|-------|
| | | | | | | | |
| | | | | | | | |
| | | | | | | | |
...
4. Hvad vil jeg øve mig anderledes på baseret på i dag?
...
2. Hvad virker i min træningstilgang?
3. Hvad virker ikke?
...
3. **Registrer kun fiaskoer** - Fejr også sejre!
4. **Anmelder aldrig** - Styrken ligger i at læse tidligere indlæg
5. **For længe ventetid** - Skriv inden for 30 minutter efter afslutning
:::
...
| Målområde | Delmål | Faktisk | Fremskridt |
|-----------|--------|--------|----------|
| | | | |
| | | | |
| | | | |

...
Forskellen mellem et godt kast og et fremragende kast sker ofte, før kuglen forlader din hånd. En veldesignet rutine før kast er dit anker i konkurrencens storm – en pålidelig sekvens, der forbereder dit sind og din krop til optimal præstation.
...
- **Konsistens**: Samme forberedelse fører til mere ensartet udførelse
- **Fokus**: Giver dit sind en konstruktiv opgave i stedet for at bekymre dig
- **Overgang**: Hjælper dig med at skifte fra at tænke til at handle
- **Preshåndtering**: Velkendte handlinger beroliger nervesystemet
- **Nulstil**: Sletter det forrige billede fra dit sind

## Anatomien af en effektiv rutine

En god rutine før indtagelse har tre faser:

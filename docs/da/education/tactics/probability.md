...
```mermaid
graph TD
    A[Beslutningspunkt] --> B[Mulighed 1]
    A --> C[Mulighed 2]
    A --> D[Mulighed 3]

    B --> E[Sandsynlighed for succes]
    B --> F[Belønning hvis succes]
    B --> G[Omkostninger ved fiasko]

    C --> H[Sandsynlighed for succes]
    C --> I[Belønning hvis succes]
    C --> J[Omkostninger ved fiasko]

    D --> K[Sandsynlighed for succes]
    D --> L[Belønning hvis succes]
    D --> M[Omkostninger ved fiasko]

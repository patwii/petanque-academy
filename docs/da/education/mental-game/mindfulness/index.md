...
```mermaid
graph TD
    A[Tanker opstår] --> B{Notice it?}
    B -->|No - Autopilot| C[Bliv fanget i tanker]
    B -->|Yes - Mindful| D[Observer uden at dømme]

    C --> E[Følelsesmæssig reaktion]
    E --> F[Ydeevnen lider]

    D --> G[Lad det gå]
    G --> H[Tilbage til nutiden]
    H --> I[Hold fokus]
...
graph LR
    ...
    B --> C[OBSERVERE]
    C --> D[ACCEPTERE]
    D --> E[GLIDE/Slip Taget]
    E --> F[Tilbage til nutiden]
    F --> G[Klar til næste kast]
...
- **[Teknikker](/da/uddannelse/mentalt-spil/mindfulness/teknikker)** - Praktiske øvelser du kan bruge
- **[Daglig praksis](/da/uddannelse/mental-leg/mindfulness/daglig-praksis)** - Byg mindfulness ind i dit liv

...
```mermaid
graph TD
    A[Mestring af petanque] --> B[Teknisk fundament]
    A --> C[Mentalt spil]
...
## Bedre skud vs. flere skud: Forstå forskellen

Der er en afgørende forskel, som mange spillere overser:

::: tip Den vigtigste indsigt
**Hvis du vil lave BEDRE skud** → Arbejd på din teknik

**Hvis du vil tage FLERE shots** → Arbejd på din mentale styrke
:::

### Hvad betyder dette?

**At tage bedre billeder** betyder at udvide dit tekniske repertoire:
- Tilføjelse af nye typer kast (plombée, portée, demi-portée)
- Forbedring af præcisionen på specifikke slagtyper
- Udvikling af nye færdigheder, du ikke har i øjeblikket
- **Dette kræver teknisk øvelse og fysisk træning**

**At tage flere billeder** betyder at udføre det, du allerede ved, hvordan man gør:
- Slå de slag, du allerede kan lave i træning
- Konsekvent præstation under pres
- Stol på din teknik, når det gælder
- **Dette kræver mental træning og adgang til flowtilstand**

### Realitetstjekket

Spørg dig selv ærligt:
- Kan du lave skuddet under træning, når du er afslappet? ✅ **Så har du teknikken**
- Har du svært ved at klare dig i konkurrencer? ⚠️ **Så har du brug for mentalt arbejde, ikke mere teknisk øvelse**

::: warning Almindelig fejl
Mange erfarne spillere bruger år på at finpudse de teknikker, de allerede har, når det, de virkelig har brug for, er at udvikle den mentale styrke til at udføre dem under pres.

**Du behøver ikke en bedre armsving. Du har brug for et roligere sind.**
:::
...
```mermaid
graph LR
    A[Teknisk viden] --> B[Informerede valg]
    B --> C[Fokuseret udvikling]
    C --> D[Mestring af nøglefærdigheder]
    D --> E[Adgang til flowtilstand]

...
```mermaid
graph TD
    A[Flowtilstand] --> B[Balance mellem udfordring/færdigheder]
    A --> C[Klare mål]
    A --> D[Øjeblikkelig feedback]
    A --> E[Total fokus]
    A --> F[Tab af selvbevidsthed]
    A --> G[Følelse af kontrol]
...
```mermaid
graph LR
    A[Vurdering <br/> Udenfor cirkel] --> B[Overgang <br/> Gå ind i cirklen]
    B --> C[Fysisk opsætning <br/> I cirklen]
    C --> D[Visualisering <br/> 2-3 sekunder]
    D --> E[Udførelse <br/> Kaste]
...
|------------|---------------------|------------------|
| **Intern** ❌ | Din kropsmekanik | &quot;Hold min albue lige&quot;<br/> &quot;Følg ordentligt op&quot;<br/> &quot;Grib ikke for hårdt&quot; |
| **Ekstern** ✅ | Mål og resultat | &quot;Land den lige der&quot;<br/> &quot;Se stien&quot;<br/> &quot;Ram målet&quot; |
...
```mermaid
graph LR
    A[Langsom åndedræt] --> B[Aktiverer rosystemet]
    B --> C[Lavere puls]
    B --> D[Afslappede muskler]
    B --> E[Klar sind]
...
```mermaid
graph LR
    A[Fejl] --> B[STOP <br/> Pause]
    B --> C[OBSERVERE <br/> Meddelelse]
    C --> D[ACCEPTERE <br/> Det skete]
    D --> E[GLIDE <br/> Slip fri]
    E --> F[Tilbage til nutiden]

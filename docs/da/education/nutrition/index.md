...
4. **Hold dig hydreret** - Dehydrering påvirker koncentrationen betydeligt
...
```mermaid
graph TD
    A[Nuværende kost] --> B[Gradvise ændringer]
    B --> C[Kropstilpasning<br/>2-4 uger]
    C --> D[Ny normal]
    D --> E[Konkurrenceklar]

    F[Pludselig ændring<br/>Konkurrencedag] --> G[Fordøjelsesbesvær]
    G --> H[Dårlig præstation]

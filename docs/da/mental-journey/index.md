...
| **Materialer** | Deltagervejledninger, slides og arbejdsark | [Se materialer](/da/mental-journey/materialer) |
| **Relaterede vejledninger** | Avancerede formater | [Workshop](/da/workshop) • [Træningslejr](/da/træningslejr) |
...
```mermaid
graph TD
    A[Mental træning] --> B[Bedre fokus]
    A --> C[Trykstyring]
    A --> D[Hurtigere genopretning]
    A --> E[Mere konsistens]
    
    B --> F[Forbedret ydeevne]
    C --> F
    D --> F
    E --> F
...
2. Spor mental præstation i [Dagbogsskabelon](/da/dagbogsskabelon)
3. Sæt mentale spilmål ved hjælp af [Målskabelon](/da/målskabelon)

### Mulighed 2: Gruppeworkshop (for trænere)

**Udfør en 2-3 timers session:**

Brug vores omfattende [Sessionsguide](/da/mental-journey/sessionsguide), som inkluderer:
...
### For trænere/guider
- [Sessionsguide](/da/mental-journey/sessionsguide) - Komplet 2-3 timers workshop
- [Materialer til undervisere](/da/mental-journey/materialer) - Digitale guider og slides
- [Workshopguide](/da/workshop) - Avanceret 3-4 timers format
- [Træningslejrguide](/da/træningslejr) - Weekendprogram
...
- Se [Casestudier](/da/casestudier) for eksempler
...
**Download materialer:** Besøg [Facilitatormaterialer](/da/mental-journey/materialer)
:::

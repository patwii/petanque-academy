...
```mermaid
graph LR
    A[Traditionel træning] --> B[Teknisk fokus]
    B --> C[Plateau]

    D[Pétanque Academy] --> E[Fokus på flowtilstand]
    E --> F[Næste niveau af ydeevne]
...
```mermaid
graph TD
    A[Elitespiller] --> B[Teknisk mestring]
    B --> C{What's Next?}

...
Ce modèle vous aide à définir des objectifs pertinents et à suivre vos progrès de manière systématique. Copiez les sections ci-dessous dans le format de votre choix (Word, Google Docs, Excel, Google Sheets ou un bloc-notes).
...
| Type d&#39;objectif | Objectif spécifique | Importance de l&#39;objectif | Indicateur de succès |
|-----------|---------------|------------------|----------------|
| **Résultats du tournoi** | Exemple : Top 8 au championnat régional | Pour prouver que je peux rivaliser au niveau régional | Classement parmi les 8 premiers |
| **Classement** | | | |
| **Cohérence** | | | |
...
| Domaine de compétences | Niveau actuel (1-10) | Niveau cible | Spécialisation |
|------------|---------------------|--------------|----------------|
...
| Zone | État actuel | État cible | Méthode d&#39;entraînement |
|------|---------------|--------------|-----------------|
...
| Zone | Actuelle | Cible | Plan d&#39;action |
|------|---------|--------|-------------|
...
| Zone cible | Objectif initial | Ajustement nécessaire | Nouvelle cible |
|-----------|---------------|-------------------|------------|
| | | | |
| | | | |
| | | | |
...
| Semaine | Objectif spécifique | Axe d&#39;entraînement | Compétition/Test |
|------|----------------|----------------|------------------|
| **Semaine 1** | | | |
| **Semaine 2** | | | |
| **Semaine 3** | | | |
...
- [ ] Réflexion/journal : _____ entrées

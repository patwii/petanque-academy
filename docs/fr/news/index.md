...
```mermaid
graph TD
    A[Lancement de l&#39;Académie de Pétanque] --> B[Plateforme éducative]
    A --> C[Programme d&#39;atelier]
    A --> D[Développement communautaire]

    B --> E[Contenu du jeu mental]
    B --> F[Guides nutritionnels]
    B --> G[Méthodes de formation]

    C --> H[Forums des joueurs d&#39;élite]
    C --> I[Apprentissage par les pairs]

    D --> J[Croissance partagée]

...
Des modèles pratiques pour vous accompagner dans votre développement.
...
- Suivi de la corrélation entre le sommeil et les performances
...
**Comprend :**
- Liste de vérification la veille (logistique, nutrition, préparation mentale, sommeil)
- routine matinale de compétition
- Protocoles de compétition
- Liste de contrôle du sac de compétition
- Réflexion post-compétition
...
- Règles pour donner des commentaires
- format de séance de retour d&#39;information d&#39;équipe
- Cadre de réception des commentaires
...
**Comprend :**
- Attribution des rôles (sur le terrain et en dehors)
- Accords de communication et signaux manuels
- Protocoles de prise de décision
- Engagements en matière d&#39;entraînement et de compétition
- Étapes de résolution des conflits
- Principes directeurs relatifs à la culture du feedback
...
**Comprend :**
- Protocole de réinitialisation de 30 secondes
- technique de réinitialisation de la prise
- Protocole de pré-lancer de 15 secondes
- Respiration d&#39;urgence 4-7-8
- Rappel du mot-clé
...
**Comprend :**
- Aliments à privilégier ou à éviter le jour de la compétition
- Chronologie de la veille de la compétition
- Liste de contrôle des collations de compétition
- Signes avant-coureurs indiquant qu&#39;il faut manger maintenant
- Modèle de planification de repas personnel
...
- Sections consacrées aux objectifs à court et à long terme
- Suivi des progrès
- Sujets de réflexion
...
**Comprend :**
- Définition des intentions avant la séance
- Réflexion post-session
- Notes sur la compétition
- Suivi de l&#39;état mental
...
1. **Téléchargez** le modèle qui correspond à vos besoins
2. **Personnalisez-le** en fonction de vos objectifs et de votre situation personnels.
3. **Utilisez-le régulièrement** — la valeur ajoutée provient d&#39;une utilisation régulière
4. **À revoir périodiquement** — recherchez des tendances et des progrès

::: tip Numérique ou papier ?
Les deux options sont valables. Certains joueurs préfèrent le papier pour le contact et pour éviter les écrans. D&#39;autres privilégient le numérique pour la recherche et la praticité. Choisissez ce que vous utiliserez réellement.
:::

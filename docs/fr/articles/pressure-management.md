...
```mermaid
flowchart TD
    A[Moment crucial] --> B[Réponse de combat ou de fuite]
    B --> C[Fréquence cardiaque ↑]
    B --> D[Respiration superficielle]
    B --> E[Tension musculaire]
    B --> F[Concentration réduite]

...
```mermaid
graph TD
    A[Autonomie <br/> Choix et contrôle] --> D[Intrinsèque <br/> Motivation]
    B[Compétence <br/> Maîtrise et croissance] --> D
    C[Lien de parenté <br/> Lien et appartenance] --> D
    D --> E[Durable <br/> Performance]

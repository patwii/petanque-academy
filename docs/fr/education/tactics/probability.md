...
```mermaid
graph TD
    A[Point de décision] --> B[Option 1]
    A --> C[Option 2]
    A --> D[Option 3]

    B --> E[Probabilité de succès]
    B --> F[Récompense en cas de succès]
    B --> G[Coût en cas d&#39;échec]

    C --> H[Probabilité de succès]
    C --> I[Récompense en cas de succès]
    C --> J[Coût en cas d&#39;échec]

    D --> K[Probabilité de succès]
    D --> L[Récompense en cas de succès]
    D --> M[Coût en cas d&#39;échec]
    ...
    N --> Q[Choisissez le meilleur véhicule électrique]
    O --> Q
    P --> Q

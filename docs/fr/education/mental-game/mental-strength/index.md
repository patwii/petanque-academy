...
```mermaid
graph TD
    A[Situation de pression] --> B{Mental Strength?}
    B -->|Weak| C[pensées négatives]
    B -->|Strong| D[Routine avant le tir]

    C --> E[La tension augmente]
    E --> F[baisse des performances]
    F --> G[Plus de pression]
    G --> C

    D --> H[Concentrez-vous sur le processus]
    H --> I[Formation à la confiance]
    I --> J[Exécuter correctement]
    J --> K[La confiance grandit]
...
```mermaid
graph LR
    A[Meilleure préparation] --> B[Plus de confiance]
    B --> C[Meilleures performances]
    C --> D[Plus de confiance]
    D --> A
...
- **[Gérer la pression](/en/education/mental-game/mental-strength/handling-pressure)** - Techniques pour les situations à forts enjeux
- **[Routine d&#39;avant-tir](/en/education/mental-game/mental-strength/pre-shot-routine)** - Développer son déclencheur de performance

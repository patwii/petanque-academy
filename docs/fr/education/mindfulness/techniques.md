...
```mermaid
graph TD
    A[Pratique de la pleine conscience] --> B[Pratiques formelles]
    A --> C[Pratiques informelles]
    A --> D[Spécifique à la compétition]

    B --> E[Méditation assise]
    B --> F[Scan corporel]
    B --> G[Méditation en marchant]

    C --> H[Respiration consciente]
    C --> I[Méthode SOAS]
    C --> J[Manger en pleine conscience]

    D --> K[Respiration avant le tir]
    D --> L[Réinitialisation entre les lancers]
    D --> M[Cloche de pleine conscience]

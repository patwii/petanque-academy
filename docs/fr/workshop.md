...
- **Débutant (2-3 h) :** Introduction aux concepts du jeu mental → [Voir le guide du parcours mental](/fr/mental-journey/session-guide)
...
| **Guides associés** | Autres formats de formation | [Voyage mental](/fr/mental-journey/) • [Camp d&#39;entraînement](/fr/training-camp) |
...
```mermaid
graph LR
    A[Atelier] --> B[Fondation 60 min]
    B --> C[Travail en profondeur 90 min]
    C --> D[Intégration 45 min]
    D --> E[Fermeture dans 15 minutes]
...
```mermaid
graph TD
    A[Espace physique] --> B[Signes de changement mental]
    A --> C[Pas de barrières]
    A --> D[Égalité des chances]

    B --> E[Sécurité psychologique]
    C --> E
    D --> E
...
```mermaid
graph TD
    A[Matrice d&#39;enregistrement] --> B[Énergie élevée + Positive]
    A --> C[Énergie élevée + Négative]
    A --> D[Faible énergie + Positive]
    A --> E[Faible énergie + Négatif]

    B --> F[Reconnaître tous les États]
    C --> F
    D --> F
    E --> F
...
```mermaid
graph TD
    A[La peur dans un chapeau] --> B[Partage anonyme]
    B --> C[Validation par les pairs]
    C --> D[La honte se dissout]
    D --> E[Pauses d&#39;isolement]
    E --> F[Sécurité psychologique]

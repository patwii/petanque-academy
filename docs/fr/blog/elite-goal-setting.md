...
Se fixer des objectifs semble simple : décider de ce que l’on veut et œuvrer pour l’obtenir. Mais la définition d’objectifs de haut niveau est plus nuancée. Les bons objectifs accélèrent le développement ; les mauvais engendrent frustration et stagnation.

## Au-delà des objectifs de base

La plupart des joueurs se fixent des objectifs de résultat : « Gagner le championnat régional. » Ces objectifs posent problème :
- Vous ne pouvez pas contrôler entièrement les résultats
- Ils créent une pression sans direction.
- Le succès ou l&#39;échec est binaire.
- Ils ne guident pas la pratique quotidienne
...
Ces éléments sont entièrement contrôlables et contribuent à l&#39;atteinte des objectifs de performance.

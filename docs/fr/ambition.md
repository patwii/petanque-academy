...
```mermaid
graph LR
    A[Formation traditionnelle] --> B[Focus technique]
    B --> C[Plateau]

    D[Pétanque Academy] --> E[Concentration sur l&#39;état de flux]
    E --> F[Performance de niveau supérieur]
...
```mermaid
graph TD
    A[Joueur d&#39;élite] --> B[Maîtrise technique]
    B --> C{What's Next?}

    C --> D[Jeu mental]
    C --> E[État de flux]
    C --> F[Nutrition]
    C --> G[pleine conscience]

    D --> H[Performance optimale]
    E --> H
    F --> H
    G --> H

...
```mermaid
graph LR
    A[Daglig övning] --> B[Neurala banor]
    B --> C[Automatisk färdighet]
    C --> D[Tävlingsprestanda]
...
```mermaid
graph TD
    A[Konsekvent praxis] --> B[Vecka 1: Bygga vanor]
    B --> C[Månad 1: Förmåner från uppsägning]
    C --> D[Månad 3: Mer naturligt]
    D --> E[Årskurs 1+: Grundläggande färdighet]

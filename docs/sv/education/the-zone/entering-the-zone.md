...
```mermaid
graph TD
    A[Flödesstatus] --> B[Utmaning/färdighetsbalans]
    A --> C[Tydliga mål]
    A --> D[Omedelbar återkoppling]
    A --> E[Totalt fokus]
    A --> F[Förlust av självmedvetenhet]
    A --> G[Känsla av kontroll]
...
|------------|---------------------|------------------|
| **Internt** ❌ | Din kroppsmekanik | &quot;Håll min armbåge rak&quot;<br/> &quot;Följ upp ordentligt&quot;<br/> &quot;Håll inte för hårt&quot; |
| **Extern** ✅ | Mål och resultat | &quot;Landa den där&quot;<br/> &quot;Se vägen&quot;<br/> &quot;Träffa målet&quot; |
...
```mermaid
graph LR
    A[Långsam andning] --> B[Aktiverar lugnsystemet]
    B --> C[Lägre hjärtfrekvens]
    B --> D[Avslappnade muskler]
    B --> E[Klar sinne]
...
```mermaid
graph LR
    A[Misstag] --> B[STOPP <br/> Paus]
    B --> C[OBSERVERA <br/> Varsel]
    C --> D[ACCEPTERA <br/> Det hände]
    D --> E[GLIDA <br/> Släppa]
    E --> F[Återgå till nutid]

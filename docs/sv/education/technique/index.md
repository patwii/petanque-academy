...
```mermaid
graph TD
    A[Boulemästare] --> B[Teknisk grund]
    A --> C[Mentalt spel]
...
```mermaid
graph LR
    A[Teknisk kunskap] --> B[Informerade val]
    B --> C[Fokuserad utveckling]
    C --> D[Behärskning av nyckelfärdigheter]
    D --> E[Åtkomst till flödestillstånd]

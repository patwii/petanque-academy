...
```mermaid
graph TD
    A[Beslutspunkt] --> B[Alternativ 1]
    A --> C[Alternativ 2]
    A --> D[Alternativ 3]

    B --> E[Framgångssannolikhet]
    B --> F[Belöning vid framgång]
    B --> G[Kostnad vid misslyckande]

    C --> H[Framgångssannolikhet]
    C --> I[Belöning vid framgång]
    C --> J[Kostnad vid misslyckande]

    D --> K[Framgångssannolikhet]
    D --> L[Belöning vid framgång]
    D --> M[Kostnad vid misslyckande]

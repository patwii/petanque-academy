...
```mermaid
graph TD
    A[Tankar uppstår] --> B{Notice it?}
    B -->|No - Autopilot| C[Fastna i tankar]
    B -->|Yes - Mindful| D[Observera utan att döma]

    C --> E[Känslomässig reaktion]
    E --> F[Prestandan blir lidande]

    D --> G[Släpp det]
    G --> H[Återgå till nutid]
    H --> I[Håll fokus]
...
graph LR
    ...
    B --> C[OBSERVERA]
    C --> D[ACCEPTERA]
    D --> E[SLIP/Släpp taget]
    E --> F[Återgå till nutid]
    F --> G[Redo för nästa kast]

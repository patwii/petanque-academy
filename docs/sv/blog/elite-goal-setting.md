...
Målsättning verkar enkelt: bestäm vad du vill, arbeta mot det. Men målsättning på elitnivå är mer nyanserad. Rätt mål påskyndar utvecklingen; fel mål skapar frustration och stagnation.

## Utöver grundläggande mål

De flesta spelare sätter upp resultatmål: &quot;Vinn regionsmästerskapet.&quot; Dessa mål har problem:
- Du kan inte helt kontrollera resultaten
- De skapar tryck utan riktning
- Framgång eller misslyckande är binärt
- De vägleder inte den dagliga övningen
...
Dessa är helt kontrollerbara och bygger mot prestationsmål.

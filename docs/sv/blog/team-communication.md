...
I boule kan kommunikation avgöra om ett lag lyckas eller inte. Rätt ord i rätt ögonblick bygger självförtroende och tydlighet. Fel ord – eller tystnad när ord behövs – kan förstöra även skickliga lag.

## Varför kommunikation är viktigt

Petanque-team står inför unika kommunikationsutmaningar:
...
Effektiv kommunikation skapar:
- Gemensam förståelse för strategi
- Ömsesidigt stöd och förtroende
- Snabbt och tydligt beslutsfattande
- Motståndskraft genom svåra stunder

## Kommunikationsprinciperna

### 1. Klarhet framför kvantitet

Under press är mindre mer. Tydlig och koncis kommunikation är bättre än långa diskussioner:

**Istället för:** &quot;Jag tror att vi kanske borde försöka peka här, men jag är inte säker, vad tycker du, terrängen ser knepig ut...&quot;

**Säg:** &quot;Jag pekar åt vänster. Marken är bättre där.&quot;

### 2. Positiv inramning

Rama in kommunikationen konstruktivt:

**Istället för:** &quot;Missa inte detta&quot;
**Säg:** &quot;Du klarar det här – lita på ditt kast&quot;

**Istället för:** &quot;Det var hemskt&quot;
**Säg:** &quot;Skaka av dig det, nästa&quot;

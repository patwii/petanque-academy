...
Skillnaden mellan ett bra kast och ett fantastiskt kast sker ofta innan klotet lämnar din hand. En väl utformad spelrutin före skottet är ditt ankare i tävlingens storm – en pålitlig sekvens som förbereder ditt sinne och din kropp för optimal prestation.
...
- **Konsekvens**: Samma förberedelse leder till mer konsekvent utförande
- **Fokus**: Ger ditt sinne en konstruktiv uppgift istället för att oroa sig
- **Övergång**: Hjälper dig att gå från att tänka till att göra
- **Tryckhantering**: Välbekanta handlingar lugnar nervsystemet
- **Återställ**: Raderar föregående skott från ditt sinne

## Anatomin av en effektiv rutin

En bra rutin före sprutning har tre faser:

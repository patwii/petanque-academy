...
Varje boulespelare känner till den rösten. Den som viskar &quot;du kommer att missa&quot; precis när du ska kasta. Den som spelar upp ditt senaste misslyckade slag i en oändlig loop. Detta är din inre kritiker – och att lära sig hantera den är avgörande för elitprestationer.

## Vad är den inre kritikern?

Den inre kritikern är den inre rösten som dömer, kritiserar och undergräver ditt självförtroende. I boule dyker den ofta upp i de värsta tänkbara ögonblicken:

- **Innan ett avgörande skott**: &quot;Alla tittar. Stör inte till det här.&quot;
- **Efter en miss**: &quot;Du kvävs alltid av press.&quot;
- **Under en förlustsvit**: &quot;Du är inte tillräckligt bra för den här nivån.&quot;

Den här rösten försöker inte skada dig – det är faktiskt ett missriktat försök till skydd. Din hjärna försöker förbereda dig för misslyckande så att det inte ska göra lika ont. Men detta &quot;skydd&quot; blir till självsabotage.

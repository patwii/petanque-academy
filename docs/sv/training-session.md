...
- **Ansvarsskyldighet** - Svårt att avboka på 3 personer
- **Intimitet** - Tillräckligt liten för djupgående delning
...
- Regelbundna deltagare i regionala turneringar
- Petanquegemenskaper online
- Fråga din tränare om rekommendationer

**Inbjudan:**
&gt; &quot;Jag håller på att bilda en liten träningsgrupp på fyra spelare som vill tävla regelbundet och jobba på det mentala spelet. Vi skulle träffas varje vecka i 2–3 timmar, spela hårt och sedan reflektera över vad vi lär oss. Intresserad?&quot;
...
|------|----------|----------|
| **Uppstart** | Incheckning och installation | 15 min |
| **Tävling** | 2 mot 2 matcher | 90 min |
| **Reflektion** | Avrapportering och lärande | 15 min |
...
|------|----------|----------|
| **Uppstart** | Incheckning och installation | 15 min |
| **Tävlingsrunda 1** | 2 mot 2 matcher | 60 min |
| **Paus** | Vila och informellt samtal | 15 min |
| **Tävlingsrunda 2** | Växla partners | 60 min |
| **Reflektion** | Djupgående debriefing | 30 min |

### 4-timmarssession

| Tid | Aktivitet | Varaktighet |
|------|----------|----------|
| **Uppstart** | Incheckning och installation | 20 min |
| **Tävlingsrunda 1** | 2 mot 2 matcher | 75 min |
| **Paus** | Vila och mellanmål | 15 min |
| **Tävlingsrunda 2** | Växla partners | 75 min |
| **Paus** | Vila | 10 min |
...
- Ökar medvetenheten om mentalt tillstånd
...
::: tip Sessionens grundregler
1. **Tävla hårt** - Spela för att vinna, utan att tveka
2. **Stödja tillväxt** - Hjälp varandra att lära sig
3. **Respektera användarmanualer** - Visa respekt för hur varje person vill bli behandlad
4. **Var närvarande** - Inga telefoner under lek
...
- Håll koll på resultatet ärligt
...
### Skapa en konkurrensmiljö

::: warning Kritisk: Gör det verkligt
**Detta är inte tillfällig träning.** Behandla det som en turnering:

✅ **Gör:**
- Håll officiell poäng
- Mät noggrant
- Kalla fotfel
- Ta det på allvar
- Fira bra bilder
- Visa besvikelse över misslyckanden

❌ **Gör inte:**
- Ge &quot;omarbetningar&quot;
- Vara alltför avslappnad
- Låt dåliga samtal passera
...
| Kriterium | 1 (Dåligt) | 3 (Bra) | 5 (Utmärkt) |
|-----------|-----------|-----------|---------------|
| **Förblev närvarande** | Uppehöll mig vid tidigare bilder | Mestadels närvarande | Helt i nuet |
| **Hanterad inre kritiker** | Hårt självprat | Fångad och omformulerad | Använde inre coach |
| **Emotionell reglering** | Synlig frustration | Förblev mestadels lugn | Lugn hela tiden |
| **Stödd partner** | Ignorerad eller klandrad | Grundläggande support | Använd användarmanual |

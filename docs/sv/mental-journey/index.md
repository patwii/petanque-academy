...
| **Sessionsguide** | Komplett 2-3 timmars workshopguide för handledare | [Visa guide](/sv/mental-journey/sessionsguide) |
| **Material** | Deltagarguider, bilder och arbetsblad | [Visa material](/sv/mental-journey/material) |
| **Relaterade guider** | Avancerade format | [Workshop](/sv/workshop) • [Träningsläger](/sv/träningsläger) |
...
```mermaid
graph TD
    A[Mental träning] --> B[Bättre fokus]
    A --> C[Tryckhantering]
    A --> D[Snabbare återhämtning]
    A --> E[Mer konsekvens]
    
    B --> F[Förbättrad prestanda]
    C --> F
    D --> F
    E --> F
...
2. Följ mental prestation i [Dagboksmall](/sv/dagboksmall)
3. Sätt mentala spelmål med hjälp av [Målmall](/sv/målmall)

### Alternativ 2: Gruppworkshop (för coacher)

**Genomför en 2–3 timmars session:**

Använd vår omfattande [Sessionsguide](/sv/mental-journey/sessionsguide) som inkluderar:
...
### För tränare/guider
- [Sessionsguide](/sv/mental-journey/sessionsguide) - Komplett 2-3 timmars workshop
- [Handledarematerial](/sv/mental-journey/material) - Digitala guider och bilder
- [Workshopguide](/sv/workshop) - Avancerat 3-4 timmars format
- [Träningslägerguide](/sv/träningsläger) - Helgprogram
...
- Granska [Fallstudier](/sv/fallstudier) för exempel
...
**Ladda ner material:** Besök [Handledarens material](/sv/mental-journey/materials)
:::

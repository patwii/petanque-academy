...
| **Material för sessionen** | Guider, bilder och arbetsblad | [Visa material](/sv/mental-journey/material) |
...
```mermaid
graph LR
    A[Introduktion <br/> 20 minuter] --> B[Zonen <br/> 40 minuter]
    B --> C[Bryta <br/> 10 minuter]
    C --> D[Inre kritiker <br/> 40 minuter]
    D --> E[Praktiska verktyg <br/> 40 minuter]
    E --> F[Integration <br/> 20 minuter]
...
- [ ] Bokmärk materialsidor (se [Material](/sv/mental-journey/materials))
...
- [Handledarens bilder](/sv/mental-journey/material#handledarens-bilder)

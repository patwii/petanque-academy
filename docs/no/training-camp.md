...
Denne omfattende guiden hjelper deg med å organisere og gjennomføre en helgetreningsleir som kombinerer teori, praksis og konkurranse. Bland det mentale spillinnholdet fra denne nettsiden med trening i løypa for maksimal effekt.

::: tip Treningsleirfilosofien
...
| **Teknisk trener** | Overvåke trening, gi tilbakemeldinger | 1-2 |
| **Konkurranseleder** | Gjennomføre turneringen, administrere logistikk | 1 |
...
6. **Utsjekking (15 min)** – Slutt på prosessen
...
2. **[Mental styrke](./utdanning/mental-styrke/)** (25 min)
...
2. Oppgi selvtillit: «Jeg får 7 av 10»
...
- &quot;Nevn 5 hovedsteder&quot; eller &quot;Tell baklengs fra 100 med 7&quot;
...
|---------|--------------|----------|
| **Terreng 1: Mykt/Sand** | Aksept av usikkerhet | &quot;Den uerfarne - aksepter det som er&quot; |
| **Terreng 2: Hardt/Grus** | Presisjon under press | &quot;Stol på teknikken din&quot; |
| **Terreng 3: Ujevn** | Emosjonsregulering | &quot;Vær rolig når det er urettferdig&quot; |
...
- Diskuter: «Hvordan vil dere bruke dette?»

**4. Forpliktelser (15 min)**
- Hver person forplikter seg én gang
...
- Utveksle kontakter
- Planlegg oppfølging (valgfri online-sesjon)
...
- ❌ Ikke gjør det: «Det er greit, ikke gråt»

**Konflikt mellom spillere:**
- ✅ Pause og adressering
...
- Ta tak i eventuelle sårbarhetsproblemer
...
– Ville du anbefalt det til andre?
...
| Vare | Pris per person | 20 personer | 10 personer |
|------|-------------------|------------|-----------|
| **Registrering** | €150–250 | €3 000–5 000 | €1 500–2 500 |

### Utgifter

| Kategori | Kostnad | Merknader |
|----------|------|-------|
| **Leie av lokaler** | €500–1000 | Helgepris |
| **Overnatting** | €40–60/person/natt | Delte rom |
| **Måltider** | €30–40/person/dag | 6 måltider |
| **Ansatte** | €500–1000 | MPC + trenere |
| **Materialer** | €100–200 | Arbeidsark, rekvisita |
| **Premier** | €100–200 | Anerkjennelsesartikler |
...
- [ ] Deltakelsesrate (&gt;80 % deler aktivt)
- [ ] Fullføringsgrad (&gt;90 % oppholder seg hele helgen)
- [ ] Tilfredshetspoengsum (gjennomsnitt 1–10 &gt;8)

### Langsiktige indikatorer

- [ ] Atferdsendring (ved bruk av verktøy i konkurranse)
- [ ] Prestasjonsforbedring (selvrapportert)
...
- Å overvinne skepsis
- **Fiksing:** Ta det opp direkte med verbal aikido
...
- [Veiledning for treningsøkt](./training-session) - For kontinuerlig øving
- [Ernæring](./utdanning/ernæring/) - Protokoller for konkurransedagen
- [Mental styrke](./utdanning/mental-styrke/) - Indre spillkonsepter
- [Mindfulness](./utdanning/mindfulness/) - Nærværsteknikker
- [Taktikk](./utdanning/taktikk/) - Strategisk tenkning

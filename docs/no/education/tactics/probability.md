...
```mermaid
graph TD
    A[Beslutningspunkt] --> B[Alternativ 1]
    A --> C[Alternativ 2]
    A --> D[Alternativ 3]

    B --> E[Suksesssannsynlighet]
    B --> F[Belønning hvis suksess]
    B --> G[Kostnad ved feil]

    C --> H[Suksesssannsynlighet]
    C --> I[Belønning hvis suksess]
    C --> J[Kostnad ved feil]

    D --> K[Suksesssannsynlighet]
    D --> L[Belønning hvis suksess]
    D --> M[Kostnad ved feil]

...
```mermaid
graph TD
    A[Mindfulness-praksis] --> B[Formell praksis]
    A --> C[Uformell praksis]
    A --> D[Konkurransespesifikk]

    B --> E[Sittende meditasjon]
    B --> F[Kroppsskanning]
    B --> G[Vandrende meditasjon]
    ...
    D --> K[Pre-shot Breath]
    D --> L[Tilbakestilling mellom kast]

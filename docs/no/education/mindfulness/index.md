...
```mermaid
graph TD
    A[Tanken oppstår] --> B{Notice it?}
    B -->|No - Autopilot| C[Bli fanget i tanker]
    B -->|Yes - Mindful| D[Observer uten å dømme]

    C --> E[Emosjonell reaksjon]
    E --> F[Ytelsen lider]

    D --> G[La det gå]
    G --> H[Gå tilbake til nåtiden]
    H --> I[Hold fokus]
...
graph LR
    ...
    B --> C[OBSERVERE]
    C --> D[AKSEPTERE]
    D --> E[Slipp/Slipp taket]
    E --> F[Tilbake til nåtiden]
    F --> G[Klar for neste kast]

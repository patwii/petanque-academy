...
I petanque kan kommunikasjon avgjøre om et lag er sterkt eller ikke. De riktige ordene i riktig øyeblikk bygger selvtillit og klarhet. Feil ord – eller stillhet når ord er nødvendige – kan ødelegge selv dyktige lag.

## Hvorfor kommunikasjon er viktig

Petanque-team står overfor unike kommunikasjonsutfordringer:
...
Effektiv kommunikasjon skaper:
- Felles forståelse av strategi
- Gjensidig støtte og tillit
- Rask og tydelig beslutningstaking
- Motstandskraft gjennom vanskelige stunder

## Kommunikasjonsprinsippene

### 1. Klarhet fremfor kvantitet

Under press er mindre mer. Tydelig og konsis kommunikasjon er bedre enn lange diskusjoner:

**I stedet for:** «Jeg tror kanskje vi burde prøve å peke her, men jeg er ikke sikker, hva synes du, terrenget ser vanskelig ut...»

**Si:** «Jeg peker mot venstre side. Bakken er bedre der.»

### 2. Positiv innramming

Sett kommunikasjonen på en konstruktiv måte:

**I stedet for:** «Ikke gå glipp av denne»
**Si:** «Du klarer dette – stol på kastet ditt»

**I stedet for:** «Det var forferdelig»
**Si:** «Rist det av deg, neste»
...
| *Relatert: [Lagdynamikk](/no/utdanning/lagspiller/) | [Kommunikasjon](/no/utdanning/lagspiller/kommunikasjon) | [Håndtering av press](/no/utdanning/mental-styrke/håndtering-av-press)* |

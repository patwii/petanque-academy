...
Kampen starter ikke når du kaster den første kulen – den starter dager før. Hvordan du forbereder deg i oppkjøringen til konkurransen påvirker prestasjonene dine betydelig. Elitespillere overlater ikke forberedelsene til tilfeldighetene.
...
Å prøve å forbedre seg de siste dagene fører til tretthet, ikke gevinst.

### Undersøvn

Å ofre søvn for ekstra trening slår tilbake.

### Nye eksperimenter

Konkurransedagen er ikke for å prøve nye teknikker eller utstyr.

### Ignorerer nerver

Å late som om du ikke er nervøs hjelper ikke. Anerkjenn og håndter.

### Dårlig logistikk

Å haste på grunn av dårlig planlegging skaper unødvendig stress.

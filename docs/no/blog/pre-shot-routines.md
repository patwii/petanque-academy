...
Forskjellen mellom et godt kast og et fantastisk kast skjer ofte før kulen forlater hånden din. En godt utformet rutine før kasting er ankeret ditt i konkurransens storm – en pålitelig sekvens som forbereder sinn og kropp for optimal ytelse.
...
- **Konsistens**: Samme forberedelse fører til mer konsistent utførelse
- **Fokus**: Gir tankene dine en konstruktiv oppgave i stedet for å bekymre seg
- **Overgang**: Hjelper deg med å gå fra å tenke til å gjøre
- **Presshåndtering**: Kjente handlinger beroliger nervesystemet
- **Tilbakestill**: Fjerner det forrige bildet fra tankene dine

## Anatomien til en effektiv rutine

En god rutine før inntak har tre faser:
...
| *Relatert: [Veiledning for rutine før sprøyting](/no/utdanning/mental-styrke/rutine-før-sprøyting) | [Håndtering av press](/no/utdanning/mental-styrke/håndtering-av-press) | [Mindfulness-teknikker](/no/utdanning/mindfulness/teknikker)* |

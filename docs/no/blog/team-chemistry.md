...
Du har sett det: lag der helheten overgår summen av delene. Spillere som forventer hverandre, støtter hverandre og presterer bedre sammen enn alene. Dette er lagkjemi – og det er ikke tilfeldig.

## Hva er lagkjemi?

Lagkjemi er kvaliteten på relasjoner og samhandling som gjør at et team kan fungere som en enhet. Det inkluderer:

- **Tillit**: Tillit til hverandres evner og intensjoner
- **Forståelse**: Å vite hvordan lagkamerater tenker og spiller
- **Kommunikasjon**: Effektiv informasjonsutveksling
- **Støtte**: Gjensidig oppmuntring og bistand
- **Glede**: Ekte glede av å spille sammen

## Hvorfor kjemi er viktig

Lag med sterk kjemi:
- Ta bedre kollektive beslutninger
- Komme seg raskere etter tilbakeslag
- Prestere mer konsekvent under press
- Kos deg mer med konkurranse
- Holde sammen lenger

Lag uten kjemi:
- Skyld på hverandre for feil
- Kommuniserer dårlig under stress
- Underpresterer i forhold til individuelt talent
- Opplev konflikt og frustrasjon
...
| *Relatert: [Lagdynamikk](/no/utdanning/lagspiller/) | [Kommunikasjon](/no/utdanning/lagspiller/kommunikasjon) | [Ledelse i petanque](/no/blogg/lagledelse)* |

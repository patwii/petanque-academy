...
Lederskap i petanque handler ikke bare om å være kaptein eller den beste spilleren. Det handler om innflytelse, støtte og å få frem det beste i laget ditt. Hver spiller kan lede på forskjellige måter.

## Hva er petanque-ledelse?

Effektiv petanque-ledelse betyr:
- Å ta gode avgjørelser under press
- Støtter lagkamerater gjennom utfordringer
- Opprettholde teamfokus og energi
- Modellering av atferden du ønsker å se
- Tar ansvar for teamets resultater
...
| *Relatert: [Lagdynamikk](/no/utdanning/lagspiller/) | [Kommunikasjon](/no/utdanning/lagspiller/kommunikasjon) | [Bygge lagkjemi](/no/blogg/lagkjemi)* |

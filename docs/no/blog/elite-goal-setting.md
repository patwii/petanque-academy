...
Målsetting virker enkelt: bestem deg for hva du vil, og jobb mot det. Men målsetting på elitenivå er mer nyansert. De riktige målene akselererer utviklingen; de gale målene skaper frustrasjon og stagnasjon.

## Utover grunnleggende mål

De fleste spillere setter seg mål for resultatet: «Vinne regionmesterskapet». Disse målene har problemer:
- Du kan ikke kontrollere resultatene fullt ut
- De skaper press uten retning
- Suksess eller fiasko er binært
- De veileder ikke den daglige praksisen
...
Disse er fullt kontrollerbare og bygger mot ytelsesmål.

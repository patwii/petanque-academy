...
```mermaid
graph LR
    A[Introduksjon <br/> 20 minutter] --> B[Sonen <br/> 40 minutter]
    B --> C[Brudd <br/> 10 minutter]
    C --> D[Indre kritiker <br/> 40 minutter]
    D --> E[Praktiske verktøy <br/> 40 minutter]
    E --> F[Integrering <br/> 20 minutter]
...
- [ ] Bokmerk materialsider (se [Materialer](/no/mental-journey/materials))
...
- Anbefalt startmodul: [Sonen](/no/utdanning/sonen/)

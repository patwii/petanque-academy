...
- Faste spillere i regionale turneringer
- Petanque-fellesskap på nett
...
|------|----------|----------|
| **Oppstart** | Innsjekking og oppsett | 15 min |
| **Konkurranse** | 2 mot 2-kamper | 90 min |
| **Refleksjon** | Oppsummering og læring | 15 min |
...
|------|----------|----------|
| **Oppstart** | Innsjekking og oppsett | 15 min |
| **Konkurranserunde 1** | 2 mot 2-kamper | 60 min |
| **Pause** | Hvile og uformell prat | 15 min |
| **Konkurranserunde 2** | Roter partnere | 60 min |
| **Refleksjon** | Dyp debriefing | 30 min |

### 4-timers økt

| Tid | Aktivitet | Varighet |
|------|----------|----------|
| **Oppstart** | Innsjekking og oppsett | 20 min |
| **Konkurranserunde 1** | 2 mot 2-kamper | 75 min |
| **Pause** | Hvile og mellommåltid | 15 min |
| **Konkurranserunde 2** | Roter partnere | 75 min |
| **Pause** | Hvile | 10 min |
...
- Noen ganger velger de ubehagelig terrenget med vilje
...
- Normaliserer det å være &quot;av&quot; noen dager
...
::: tip Grunnregler for økt
1. **Konkurrer hardt** - Spill for å vinne, uten å holde tilbake
2. **Støtt vekst** - Hjelp hverandre å lære
3. **Respekter brukermanualer** - Vis respekt for hvordan hver person ønsker å bli behandlet
...
**Saldoen:**
&gt; «Vi konkurrerer som om det var en turnering, men vi støtter opp som om vi var lagkamerater. Hardt mot spillet, mykt mot personen.»
...
::: warning Kritisk: Gjør det til virkelighet
**Dette er ikke tilfeldig trening.** Behandle det som en turnering:

✅ **Gjør:**
- Hold offisiell poengsum
- Mål nøyaktig
- Kall fotfeil
- Ta det på alvor
- Feir gode bilder
- Vis skuffelse over bommer

❌ **Ikke:**
- Gi «omarbeidelser»
- Være altfor avslappet
...
|-----------|-----------|-----------|---------------|
| **Forble til stede** | Dvelte ved tidligere bilder | Stort sett til stede | Helt til stede i nuet |
| **Håndtert indre kritiker** | Hard selvsnakk | Fanget opp og omformulert | Brukt indre coach |
| **Emosjonell regulering** | Synlig frustrasjon | Forble stort sett rolig | Rolig gjennom hele |
| **Støttet partner** | Ignorert eller klandret | Grunnleggende støtte | Brukt brukerhåndbok |
| **Fokus** | Distrahert, ufokusert | For det meste fokusert | Laserfokusert |

...
```mermaid
graph TD
    A[Mestring av petanque] --> B[Teknisk fundament]
    A --> C[Mentalt spill]
...
```mermaid
graph LR
    A[Teknisk kunnskap] --> B[Informerte valg]
    B --> C[Fokusert utvikling]
    C --> D[Mestring av nøkkelferdigheter]
    D --> E[Tilgang til flyttilstand]

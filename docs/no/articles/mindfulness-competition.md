...
```mermaid
flowchart TD
    A[Konkurransedyktig mindfulness] --> B[Nåværende øyeblikk <br/> Bevissthet]
    A --> C[Ikke-dømmende <br/> Observasjon]
    A --> D[Bevisst <br/> Oppmerksomhet]
    A --> E[Emosjonell <br/> Regulering]

    B --> F[Ikke i fortid eller fremtid]
    C --> G[Legg merke til uten å dømme]
    D --> H[Velg ditt fokus]
    E --> I[Føl uten å bli kontrollert]

...
```mermaid
graph TD
    A[Padronanza della boccia] --> B[Fondazione tecnica]
    A --> C[Gioco mentale]
...
```mermaid
graph LR
    A[Conoscenza tecnica] --> B[Scelte informate]
    B --> C[Sviluppo mirato]
    C --> D[Padronanza delle competenze chiave]
    D --> E[Accesso allo stato del flusso]

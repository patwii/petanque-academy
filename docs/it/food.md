...
```mermaid
graph TD
    A[Strategia nutrizionale] --> B[Glicemia stabile]
    A --> C[Proteine e grassi sani]
    A --> D[Idratazione]

    B --> E[Messa a fuoco nitida]
    B --> F[Mani ferme]
    B --> G[Calma i nervi]
...
```mermaid
graph LR
    A[Zucchero/Carboidrati semplici] --> B[Arpione]
    B --> C[Incidente]
    C --> D[Tremori e ansia]

    E[Proteine e grassi] --> F[Stabile]
    F --> G[Prestazioni costanti]
...
```mermaid
graph TD
    A[Mangia zucchero] --> B[picchi di zucchero nel sangue]
    B --> C[Insulina rilasciata]
    C --> D[Crolli della glicemia]
    D --> E[Risposta all&#39;adrenalina]
    E --> F[Tremori]
    E --> G[Ansia]
    E --> H[scarsa concentrazione]

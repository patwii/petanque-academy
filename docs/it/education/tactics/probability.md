...
```mermaid
graph TD
    A[Punto di decisione] --> B[Opzione 1]
    A --> C[Opzione 2]
    A --> D[Opzione 3]

    B --> E[Probabilità di successo]
    B --> F[Ricompensa in caso di successo]
    B --> G[Costo in caso di fallimento]

    C --> H[Probabilità di successo]
    C --> I[Ricompensa in caso di successo]
    C --> J[Costo in caso di fallimento]

    D --> K[Probabilità di successo]
    D --> L[Ricompensa in caso di successo]
    D --> M[Costo in caso di fallimento]
    ...
    N --> Q[Scegli il miglior veicolo elettrico]
    O --> Q
    P --> Q

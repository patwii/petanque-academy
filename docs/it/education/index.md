...
```mermaid
graph TD
    A[Inizio: Comprensione del flusso] --> B[La zona]
    B --> C[Pratica di consapevolezza]
    C --> D[Definizione degli obiettivi]
    D --> E[Forza mentale]
    E --> F[Dinamiche di squadra]

    B --> G[Tattiche]
    G --> H[Metodi di allenamento]

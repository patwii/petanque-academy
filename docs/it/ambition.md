...
```mermaid
graph LR
    A[Formazione tradizionale] --> B[Focus tecnico]
    B --> C[Altopiano]

    D[Pétanque Academy] --> E[Focus sullo stato di flusso]
    E --> F[Prestazioni di livello successivo]
...
```mermaid
graph TD
    A[Giocatore d&#39;élite] --> B[Padronanza tecnica]
    B --> C{What's Next?}

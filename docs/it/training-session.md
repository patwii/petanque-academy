...
- Può impegnarsi a rispettare un programma regolare
...
|------|----------|----------|
| **Avvio** | Check-in e configurazione | 15 min |
| **Competizione** | Partite 2 contro 2 | 90 min |
| **Riflessione** | Debriefing e apprendimento | 15 min |
...
|------|----------|----------|
| **Avvio** | Check-in e configurazione | 15 min |
| **Round 1 della competizione** | Partite 2 contro 2 | 60 min |
| **Pausa** | Riposo e chiacchierata informale | 15 min |
| **Round di gara 2** | Ruota i partner | 60 min |
| **Riflessione** | Debriefing approfondito | 30 min |

### Sessione di 4 ore

| Tempo | Attività | Durata |
|------|----------|----------|
| **Avvio** | Check-in e configurazione | 20 min |
| **Round 1 della competizione** | Partite 2 contro 2 | 75 min |
| **Pausa** | Riposo e spuntino | 15 min |
| **Round di gara 2** | Ruota i partner | 75 min |
| **Pausa** | Riposo | 10 min |
...
3. **Intenzione**: &quot;Oggi voglio lavorare per mantenere la calma dopo gli errori&quot;
...
::: Regole di base della sessione di suggerimento
...
## Regole di condotta della competizione
...
- Misurare quando necessario (non tirare a indovinare)
...
|---------------|----------|----------|----------|
| **Restava presente** | Si soffermava sugli scatti passati | Per lo più presente | Completamente immerso nel momento |
| **Critico interiore gestito** | Dure riflessioni interiori | Catturato e riformulato | Coach interiore utilizzato |
| **Regolazione emotiva** | Frustrazione visibile | Sono rimasto per lo più calmo | Calmo per tutto il tempo |
| **Partner supportato** | Ignorato o incolpato | Supporto di base | Manuale utente utilizzato |
| **Focus** | Distratto, non concentrato | Per lo più concentrato | Concentrato al laser |
...
- Spettatori (invitano altri a guardare)

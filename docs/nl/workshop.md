...
graph TD
    ...
    C --> G[Regelmatige check-ins]
    C --> H[Verder delen]
    C --> I[Flexibele planning]
...
```mermaid
graph TD
    A[Leren van leeftijdsgenoten] --> B[Gedeelde ervaringen]
    A --> C[Meerdere perspectieven]
    A --> D[Wederzijdse ondersteuning]

    B --> E[Je bent niet alleen.]
    C --> F[Nieuwe inzichten]
    D --> G[Verantwoordelijkheid]

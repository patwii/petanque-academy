...
```mermaid
graph TD
    A[Trainingsevolutie] --> B[Beginners: Technische oefeningen]
    B --> C[Gemiddeld niveau: Willekeurige oefening]
    C --> D[Geavanceerd: Druksimulatie]
    D --> E[Elite: Mentale training]
...
```mermaid
graph TD
    A[Concurrentie] --> B[Wedstrijdsimulatie]
    B --> C[Druktraining]
    C --> D[Willekeurige/gevarieerde oefening]
    D --> E[Geblokkeerde technische praktijk]
...
- **[Trainingsoefeningen](/en/education/training/drills)** - Specifieke oefeningen voor verschillende vaardigheden

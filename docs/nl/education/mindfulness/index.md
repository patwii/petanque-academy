...
```mermaid
graph TD
    A[Gedachte ontstaat] --> B{Notice it?}
    B -->|No - Autopilot| C[Verstrikt raken in gedachten]
    B -->|Yes - Mindful| D[Observeer zonder oordeel.]

    C --> E[Emotionele reactie]
    E --> F[De prestaties lijden eronder.]
...
graph LR
    ...
    F --> G[Klaar voor de volgende worp.]
...
- **[Technieken](/en/education/mindfulness/techniques)** - Praktische oefeningen die je kunt gebruiken
- **[Dagelijkse oefening](/en/education/mindfulness/daily-practice)** - Mindfulness integreren in je leven

...
```mermaid
graph TD
    A[Beslissingspunt] --> B[Optie 1]
    A --> C[Optie 2]
    A --> D[Optie 3]

    B --> E[Succeskans]
    B --> F[Beloning bij succes]
    B --> G[Kosten bij mislukking]

    C --> H[Succeskans]
    C --> I[Beloning bij succes]
    C --> J[Kosten bij mislukking]

    D --> K[Succeskans]
    D --> L[Beloning bij succes]
    D --> M[Kosten bij mislukking]

    E --> N[Verwachte waarde]
    F --> N
    G --> N

    H --> O[Verwachte waarde]
    I --> O
    J --> O

    K --> P[Verwachte waarde]
    L --> P
    M --> P

    N --> Q[Kies de beste elektrische auto]
    O --> Q
    P --> Q

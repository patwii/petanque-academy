...
```mermaid
graph LR
    A[Technische modus] -->|Step into circle| B[Stroommodus]
    B -->|After throw| C[Observatie]
    C -->|Volgende worp| A
...
- **[Technische training versus flowtraining](/nl/education/mental-game/the-zone/technical-vs-flow)** - Begrijpen wanneer je je op techniek moet concentreren en wanneer je moet loslaten
- **[De zone betreden](/nl/education/mental-game/the-zone/entering-the-zone)** - Praktische technieken om de flowtoestand te bereiken

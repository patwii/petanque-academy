...
```mermaid
graph TD
    A[Autonomie <br/> Keuze en controle] --> D[Intrinsiek <br/> Motivatie]
    B[Bevoegdheid <br/> Meesterschap en groei] --> D
    C[Verbondenheid <br/> Verbinding en erbij horen] --> D
    D --> E[Duurzaam <br/> Prestatie]

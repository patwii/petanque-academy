...
```mermaid
graph LR
    A[Suiker/eenvoudige koolhydraten] --> B[Bloedsuikerpiek]
    B --> C[Insulineafgifte]
    C --> D[Bloedsuikerdip]
    D --> E[Adrenalinereactie]
    E --> F[Tremoren en angst]

    G[Eiwitten en gezonde vetten] --> H[Stabiele bloedsuikerspiegel]
    H --> I[Constante energie]
    I --> J[Scherpe focus]
    J --> K[Vaste handen]

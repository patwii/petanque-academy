...
Een trainingsdagboek is je persoonlijke verslag van je oefeningen, vooruitgang en inzichten. Het helpt je bij te houden wat werkt, patronen te herkennen en je verbetering te versnellen. Kopieer de onderstaande secties naar het formaat van je voorkeur (Word, Google Docs, Excel, Google Sheets of een notitieboek).
...
## Sjabloon voor dagelijkse trainingsregistratie
...
| Geoefende vaardigheid | Herhalingen/tijd | Succespercentage | Opmerkingen |
|----------------|-----------|--------------|-------|
| **Wijzen** | | | |
| **Opnames** | | | |
| **Terreinlezen** | | | |
...
## Sjabloon voor wedstrijd-/competitie-inschrijving
...
| Ronde | Tegenstander | Score | Resultaat | Belangrijkste momenten |
|-------|----------|-------|--------|-------------|
| **1** | | | W / L | |
| **2** | | | W / L | |
| **3** | | | W / L | |
...
### Voortgang van het mentale spel
...
| Datum | Doeltype | Afstand | Pogingen | Directe treffers | Carreau | Verplaatsing | Opmerkingen |
|------|-------------|----------|----------|-------------|---------|--------------|-------|
| | | | | | | | |
| | | | | | | | |
| | | | | | | | |
...
3. Wanneer heb ik het moeilijk gehad? Waarom?
...
4. Wat ga ik anders doen naar aanleiding van vandaag?
5. Waar ben ik trots op, ongeacht het resultaat?

### Wekelijkse reflectie

1. Welk patroon zie ik in mijn werkwijze?
2. Oefen ik de dingen waar ik tijdens de wedstrijd moeite mee heb?
3. Gaat mijn mentale spel vooruit?
...
- Foto&#39;s/video&#39;s toevoegen mogelijk
...
- Geen afleiding
- Diagrammen zijn gemakkelijk te tekenen
- Bevredigend ritueel
- Beter voor reflectie

**Nadelen:**
- Kan notitieboekje kwijtraken
- Het is moeilijk om oude berichten te doorzoeken
...
::: Waarschuwing: Veelvoorkomende dagboekfouten
...
4. **Nooit recensies lezen** - De kracht zit hem in het lezen van eerdere berichten.
...
| Doelgebied | Doelstelling | Werkelijk | Voortgang |
|-----------|--------|--------|----------|
| | | | |
| | | | |
| | | | |

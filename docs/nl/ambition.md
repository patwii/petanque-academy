...
```mermaid
graph LR
    A[Traditionele training] --> B[Technische focus]
    B --> C[Plateau]

    D[Pétanque Academy] --> E[Focus op de flowtoestand]
    E --> F[Prestaties van het hoogste niveau]
...
```mermaid
graph TD
    A[Elite speler] --> B[Technische beheersing]
    B --> C{What's Next?}

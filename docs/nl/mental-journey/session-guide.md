...
| **Sessiematerialen** | Handleidingen, dia&#39;s en werkbladen | [Materialen bekijken](/en/mental-journey/materials) |
...
```mermaid
graph LR
    A[Invoering <br/> 20 min] --> B[De Zone <br/> 40 min]
    B --> C[Pauze <br/> 10 min]
    C --> D[Innerlijke criticus <br/> 40 min]
    D --> E[Praktische hulpmiddelen <br/> 40 min]
    E --> F[Integratie <br/> 20 min]
...
- [ ] Voeg de pagina&#39;s met materialen toe aan je bladwijzers (zie [Materialen](/en/mental-journey/materials))
...
- Aanbevolen startmodule: [The Zone](/en/education/the-zone/)
...
- [Deelnemershandleiding](/en/mental-journey/materials#participant-guide)
- [Facilitator Slides](/en/mental-journey/materials#facilitator-slides)
- [Samenvattingsblad](/en/mental-journey/materials#summary-sheet)
- [Oefenwerkbladen](/en/mental-journey/materials#exercise-worksheets)

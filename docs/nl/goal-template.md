...
Met deze sjabloon kunt u zinvolle doelen stellen en uw voortgang systematisch bijhouden. Kopieer de onderstaande secties naar uw favoriete formaat (Word, Google Docs, Excel, Google Sheets of een notitieboek).

::: tip De filosofie achter het stellen van doelen
...
|-----------|---------------|------------------|----------------|
| **Toernooiresultaten** | Voorbeeld: Top 8 in het Regionaal Kampioenschap | Om te bewijzen dat ik op regionaal niveau kan meedoen | Plaatsing in de top 8 |
| **Ranglijst** | | | |
| **Consistentie** | | | |
| **Teamprestaties** | | | |
...
| Vaardigheidsgebied | Huidig niveau (1-10) | Doelniveau | Specifieke focus |
|------------|---------------------|--------------|----------------|
| **Richtnauwkeurigheid** | | | Voorbeeld: 70% binnen 10 cm op 7 m |
| **Schietconsistentie** | | | |
| **Terreinaanpassing** | | | |
| **Opnameselectie** | | | |
...
| Gebied | Huidige situatie | Doelsituatie | Oefenmethode |
|------|---------------|--------------|-----------------|
| **Drukbeheer** | | | Voorbeeld: Gebruik een reset van 3 ademhalingen vóór elke opname |
| **Innerlijke criticus** | | | |
| **Focus/Concentratie** | | | |
| **Zelfvertrouwen** | | | |
...
| Doelgebied | Oorspronkelijk doel | Benodigde aanpassing | Nieuw doel |
|-----------|---------------|-------------------|------------|
| | | | |
| | | | |
| | | | |
...
| Week | Specifiek doel | Trainingsfocus | Wedstrijd/Test |
|------|----------------|----------------|------------------|
| **Week 1** | | | |
| **Week 2** | | | |
| **Week 3** | | | |
...
| Datum | Toernooi | Bereikte ronde | Plaatsing | Belangrijkste sterke punten | Verbeterpunten | Mentale toestand (1-10) |
|------|------------|---------------|-----------|---------------|------------------|---------------------|
| | | | | | | |
| | | | | | | |
| | | | | | | |
...
- **Kwartaal:** Diepgaande reflectie, grote aanpassingen
- **Jaarlijks:** Vier het jaar, stel een nieuwe visie vast

3. Wees eerlijk, niet hard

Als je een doel mist:
- ❌ **Niet doen:** &quot;Ik ben vreselijk, ik zal nooit beter worden&quot;
- ✅ **Doe:** &quot;Wat stond er in de weg? Wat kan ik aanpassen?&quot;

### 4. Koppel je doelen aan je waarom.
...
- Deel je doelen met je trainingspartner voor wederzijdse verantwoording.
...
::: Waarschuwing: Veelgemaakte fouten bij het stellen van doelen
...
::: details Voorbeeld 2: Wedstrijddoel
...
**A - Haalbaar:** Momenteel 8e-12e op de clubranglijst, verbetering is realistisch.

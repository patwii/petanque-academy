...
- **Consistentie**: Dezelfde voorbereiding leidt tot een consistentere uitvoering.
- **Focus**: Geef je geest een constructieve taak in plaats van je zorgen te maken.
- **Overgang**: Helpt je de overstap te maken van denken naar doen.
- **Stressmanagement**: Bekende handelingen kalmeren het zenuwstelsel.
- **Reset**: Hiermee wordt de vorige opname uit je geheugen gewist.

## Anatomie van een effectieve routine

Een goede voorbereiding op een fotosessie bestaat uit drie fasen:

...
Leiderschap in pétanque gaat niet alleen over aanvoerder zijn of de beste speler. Het gaat over invloed uitoefenen, steun bieden en het beste in je team naar boven halen. Iedere speler kan op een andere manier leidinggeven.

## Wat houdt pétanque-leiderschap in?

Effectief leiderschap bij pétanque betekent:
- Goede beslissingen nemen onder druk
- Teamgenoten ondersteunen tijdens uitdagingen
- Het behouden van teamfocus en energie.
- Het gedrag dat je wilt zien, zelf modelleren.
- Verantwoordelijkheid nemen voor de resultaten van het team.

...
```mermaid
graph TD
    A[Lancering van de Pétanque Academie] --> B[Onderwijsplatform]
    A --> C[Workshopprogramma]
    A --> D[Gemeenschapsopbouw]

    B --> E[Mentale spelinhoud]
    B --> F[Voedingsrichtlijnen]
    B --> G[Trainingsmethoden]

    C --> H[Elite spelersforums]
    C --> I[Leren van leeftijdsgenoten]

...
```mermaid
graph TD
    A[Pressure Situation] --> B{Mental Strength?}
    B -->|Weak| C[Negative thoughts]
    B -->|Strong| D[Pre-shot routine]

    C --> E[Tension increases]
    E --> F[Performance drops]
    F --> G[More pressure]
    G --> C

    D --> H[Focus on process]
    H --> I[Trust training]
    I --> J[Execute well]
    J --> K[Confidence grows]
...
```mermaid
graph LR
    A[Better Preparation] --> B[More Confidence]
...
- **[Handling Pressure](/en/education/mental-game/mental-strength/handling-pressure)** - Techniques for high-stakes situations
- **[Pre-Shot Routine](/en/education/mental-game/mental-strength/pre-shot-routine)** - Building your performance trigger

...
| **Session Guide** | Complete 2-3h workshop guide for facilitators | [View Guide](/en/guides/mental-journey/session-guide) |
| **Materials** | Participant guides, slides, and worksheets | [View Materials](/en/guides/mental-journey/materials) |
| **Related Guides** | Advanced formats | [Workshop](/en/guides/workshop/) • [Training Camp](/en/guides/training-camp/) |
...
```mermaid
graph TD
    A[Mental Training] --> B[Better Focus]
    A --> C[Pressure Management]
    A --> D[Faster Recovery]
    A --> E[More Consistency]
...
1. Read [The Zone](/en/education/mental-game/the-zone/) module
2. Try the 3-breath reset technique
3. Notice when you're in "technical mode" vs "flow mode"

**Week 2: Building Awareness**
1. Read [Mental Strength](/en/education/mental-game/mental-strength/) module
2. Identify your inner critic patterns
3. Practice neutral observation after mistakes

**Week 3: Creating Structure**
1. Read [Mindfulness](/en/education/mental-game/mindfulness/) module
2. Start 5-minute daily practice
3. Develop a simple pre-shot routine

**Week 4: Integration**
1. Use your routine in practice
2. Track mental performance in [Diary Template](/en/guides/templates/diary-template)
3. Set mental game goals using [Goal Template](/en/guides/templates/goal-template)

### Option 2: Group Workshop (For Coaches)

**Conduct a 2-3 Hour Session:**

Use our comprehensive [Session Guide](/en/guides/mental-journey/session-guide) which includes:
...
- [Case Studies](/en/articles/case-studies) - Real examples

### For Coaches/Guides
- [Session Guide](/en/guides/mental-journey/session-guide) - Complete 2-3h workshop
- [Facilitator Materials](/en/guides/mental-journey/materials) - Digital guides & slides
- [Workshop Guide](/en/guides/workshop/) - Advanced 3-4h format
- [Training Camp Guide](/en/guides/training-camp/) - Weekend program

## Next Steps

### For Individual Players
1. **Start with awareness** - Read [The Zone](/en/education/mental-game/the-zone/)
...
- Review [Case Studies](/en/articles/case-studies) for examples
...
::: tip Ready to Begin?
**Players:** Start with [The Zone](/en/education/mental-game/the-zone/) module

**Coaches:** Go to [Session Guide](/en/guides/mental-journey/session-guide)

**Download Materials:** Visit [Facilitator Materials](/en/guides/mental-journey/materials)
:::

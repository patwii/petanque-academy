...
Every pétanque player knows that voice. The one that whispers "you're going to miss" just as you're about to throw. The one that replays your last failed shot on an endless loop. This is your inner critic — and learning to manage it is essential for elite performance.

## What Is the Inner Critic?

The inner critic is that internal voice that judges, criticizes, and undermines your confidence. In pétanque, it often appears at the worst possible moments:

- **Before a crucial shot**: "Everyone is watching. Don't mess this up."
- **After a miss**: "You always choke under pressure."
- **During a losing streak**: "You're not good enough for this level."

This voice isn't trying to hurt you — it's actually a misguided attempt at protection. Your brain is trying to prepare you for failure so it won't hurt as much. But this "protection" becomes self-sabotage.
...
A solid [pre-shot routine](/en/education/mental-strength/pre-shot-routine) gives your mind something constructive to focus on, leaving less room for the critic.
...
*Related: [Handling Pressure](/en/education/mental-strength/handling-pressure) | [Pre-Shot Routine](/en/education/mental-strength/pre-shot-routine) | [Mindfulness Techniques](/en/education/mindfulness/techniques)*

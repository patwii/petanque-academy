...
Goal setting seems simple: decide what you want, work toward it. But elite-level goal setting is more nuanced. The right goals accelerate development; the wrong ones create frustration and stagnation.

## Beyond Basic Goals

Most players set outcome goals: "Win the regional championship." These goals have problems:
- You can't fully control outcomes
- They create pressure without direction
- Success or failure is binary
- They don't guide daily practice
...
These are fully controllable and build toward performance goals.
...
*Related: [Goal Setting Introduction](/en/education/goals/) | [SMART Goals](/en/education/goals/smart-goals) | [Planning Your Development](/en/education/goals/planning)*
